...
<<<<<<<< HEAD:streamlit_app/pages/Case_Investigation_Center.py
from styles.theme import apply_theme, COLORS
========
from streamlit_app.theme import apply_master_theme, render_page_header, get_chart_colors
>>>>>>>> origin/claude/repo-analysis-011CUmrrQ23T68ZuSYav5UVn:streamlit_app/pages/Fraud_Transaction_Monitoring.py
